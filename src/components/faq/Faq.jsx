    ...
    return(
        <section className="faq flex-column align-items-center justify-content-center" id="faq">
            ...
            <ul className="faq-items flex-column align-items-center justify-content-center">
                <li className="faq-item" onClick={animationFaq}>
                ...
                <li className="faq-item onClick={animationFaq(0)}">
                ...
                <li className="faq-item onClick={animationFaq(1)}">
                ...
                <li className="faq-item onClick={animationFaq(2)}">
                ...
                <li className="faq-item onClick={animationFaq(3)}">
                ...
                <li className="faq-item onClick={animationFaq(4)}">
                ...
                <li className="faq-item onClick={animationFaq(5)}">
                ...
                <li className="faq-item onClick={animationFaq(6)}">
                ...
                <li className="faq-item onClick={animationFaq(7)}">
                ...
                <li className="faq-item onClick={animationFaq(8)}">
